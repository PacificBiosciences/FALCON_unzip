...
blasr 000000F_reads.fa 000000F_ref.fa  -noSplitSubreads -clipping subread  -placeRepeatsRandomly -minPctIdentity 70.0  -minMatch 12  -nproc 48 -bam -out aln.bam
samtools sort aln.bam aln_sorted
samtools index aln_sorted.bam
rm aln.bam

fc_phasing.py --bam aln_sorted.bam --fasta 000000F_ref.fa --ctg_id 000000F
